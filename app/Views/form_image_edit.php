        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/Admin/update_galery" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data->id; ?>">
                        <input type="hidden" name="old_image" value="<?= $data->image_path; ?>">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="File name alternative" value="<?= $data->image; ?>" name="alternative">
                        </div>
                        <div class="input-group">
