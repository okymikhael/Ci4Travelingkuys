...
<body>
  <div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img
        src="https://ld-wt73.template-help.com/wt_prod-20476/images/ie8-panel/warning_bar_0000_us.jpg" height="42"
        width="820"
  ...
  <div class="page">
              ...
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand">
                  <!--Brand--><a class="brand" href="index.html"><img
                      src="https://ld-wt73.template-help.com/wt_prod-20476/images/logo-default.-188x19.png" alt=""
                ...
                <ul class="rd-navbar-corporate-contacts">
                  ...
                  <li>
                    <div class="unit unit-spacing-xs">
                      ...
                      <div class="unit-body"><a href="https://wa.me/6285604056893"
                          target="_blank"><?= $data_landing->phone; ?></a></div>
                    </div>
                  </li>
                </ul><a class="button button-md button-default-outline-2 button-ujarak" target="_blank"
                  href="https://wa.me/6285604056893">Contact US</a>
              </div>
            </div>
          </div>
    ...
    <!-- Swiper-->
    <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" id="home"
      ...
      <div class="swiper-wrapper text-left">
        <div class="swiper-slide context-dark"
          data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-1-1920x678.jpg">
              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100">
                    <span><?= $data_landing->banner1; ?></span></h2><a
        ...
        <div class="swiper-slide context-dark"
          data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-2-1920x678.jpg">
          <div class="swiper-slide-caption section-md">
            <div class="container">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100">
                    <span><?= $data_landing->banner2; ?></span></h2><a
                    class="button button-default-outline button-ujarak" href="#" data-caption-animate="fadeInLeft"
                    data-caption-delay="0">Get in touch</a>
                </div>
              </div>
        ...
        <div class="swiper-slide context-dark"
          data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-3-1920x678.jpg">
          <div class="swiper-slide-caption section-md">
            <div class="container">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100">
                    <span><?= $data_landing->banner3; ?></span></h2><a
                    class="button button-default-outline button-ujarak" href="#" data-caption-animate="fadeInLeft"
                    data-caption-delay="0">Get in touch</a>
                </div>
              </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-1-368x420.jpg"
              ...
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-2-368x420.jpg"
                        alt="" width="368" height="420" /></a>
              ...
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-3-368x420.jpg"
                        alt="" width="368" height="420" /></a>
      ...
      <div class="container">
        <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
          <div class="col-lg-6 text-center wow fadeInUp"><img
              src="https://ld-wt73.template-help.com/wt_prod-20476/images/index-3-556x382.jpg" alt="" width="556"
              height="382" />
          </div>
          <div class="col-lg-6 wow fadeInRight" data-wow-delay=".1s">
            <div class="box-width-lg-470">
              <h3><?= $data_landing->title1; ?></h3>
              <!-- Bootstrap tabs-->
              <div
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="tabs-7-2">
                    <p><?= $data_landing->content2; ?></p>
                    <div class="group-md group-middle"><a class="button button-secondary button-pipaluk"
                        href="contact-us.html">Get in Touch</a><a class="button button-black-outline button-md"
                        href="about.html">Read More</a></div>
                  </div>
                  <div class="tab-pane fade" id="tabs-7-3">
                    <p><?= $data_landing->content3; ?></p>
                    <div class="group-md group-middle"><a class="button button-secondary button-pipaluk"
                        href="contact-us.html">Get in Touch</a><a class="button button-black-outline button-md"
                        href="about.html">Read More</a></div>
                  </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service1; ?></p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service2; ?></p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service3; ?></p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service4; ?></p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service5; ?></p>
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="box-icon-classic">
              <div
                ...
                <div class="unit-body">
                  ...
                  <p class="box-icon-classic-text"><?= $data_landing->service6; ?></p>
                </div>
              </div>
            </article>
          </div>
        ...
        <div class="row row-sm row-40 row-md-50">
            ...
            <article class="product-big">
              <div class="unit flex-column flex-md-row align-items-md-stretch">
                <div class="unit-left"><a class="product-big-figure" href="#"><img
                      src="https://ld-wt73.template-help.com/wt_prod-20476/images/product-big-1-600x366.jpg" alt=""
          ...
          <div class="col-sm-6 col-md-12 wow fadeInLeft">
            ...
            <article class="product-big">
              <div class="unit flex-column flex-md-row align-items-md-stretch">
                <div class="unit-left"><a class="product-big-figure" href="#"><img
                      src="https://ld-wt73.template-help.com/wt_prod-20476/images/product-big-2-600x366.jpg" alt=""
                      width="600" height="366" /></a></div>
                <div class="unit-body">
                  <div class="product-big-body">
    ...
    <section class="section bg-default text-center offset-top-50">
      <div class="parallax-container"
        data-parallax-img="https://ld-wt73.template-help.com/wt_prod-20476/images/parallax-1-1920x850.jpg">
        <div class="parallax-content section-xl section-inset-custom-1 context-dark bg-overlay-2-21">
          <div class="container">
            ...
            <p class="text-width-medium text-spacing-75 wow fadeInLeft" data-wow-delay=".1s">
              <?= $data_landing->contact; ?></p><a class="button button-secondary button-pipaluk" href="#">Book a Tour
              Now</a>
          </div>
        </div>
      </div>
    ...
    <!-- Page Footer--><a class="banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html"
      target="_blank"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/intense_big_02.jpg" alt="" /></a>
                  ...
                  <ul class="footer-contacts d-inline-block d-sm-block">
                    ...
                    <li>
                      <div class="unit">
                        ...
                        <div class="unit-body"><a class="link-aemail" href="mailto:#"><?= $data_landing->email; ?></a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="unit">
                        ...
                        <div class="unit-body"><a class="link-location" href="#"><?= $data_landing->location; ?></a>
                        </div>
                      </div>
                    </li>
                  </ul>
        ...
        <div class="container">
          <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
            ...
            <div class="col-sm-6 col-md-4 order-sm-first">
              <!-- Rights-->
              <p class="rights"><span><?= $data_landing->footer; ?></p>
            </div>
