...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="https://ld-wt73.template-help.com/wt_prod-20476/images/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
  ...
  <body>
    <div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/ie8-panel/warning_bar_0000_us.jpg" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    <div class="preloader">
    ...
    <div class="page">
      <!-- Page Header-->
      <!-- <a class="banner banner-top" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" target="_blank"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/intense_02.jpg" alt=""/></a> -->
              ...
              <div class="rd-navbar-aside">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.html"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/logo-default.-188x19.png" alt="" width="225" height="18"/></a>
                  </div>
                </div>
                  ...
                  <ul class="rd-navbar-corporate-contacts">
                    ...
                    <li>
                      <div class="unit unit-spacing-xs">
                        ...
                        <div class="unit-body"><a href="https://wa.me/6285604056893" target="_blank">+62 856-040-56893</a></div>
                      </div>
                    </li>
                  </ul><a class="button button-md button-default-outline-2 button-ujarak" target="_blank" href="https://wa.me/6285604056893">Contact US</a>
                </div>
              </div>
            </div>
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#service">Our Services</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#hot">Hot Tour</a>
                    </li>
      ...
      <!-- Swiper-->
      <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" id="home" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="false" data-direction="vertical">
        <div class="swiper-wrapper text-left">
          <div class="swiper-slide context-dark" data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-1-1920x678.jpg">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                    ...
                    <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100"><span>Explore</span><span class="font-weight-bold"> Australia</span></h2><a class="button button-default-outline button-ujarak" href="#" data-caption-animate="fadeInLeft" data-caption-delay="0">Get in touch</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide context-dark" data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-2-1920x678.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="https://ld-wt73.template-help.com/wt_prod-20476/images/slider-4-slide-3-1920x678.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
              ...
              <div class="row justify-content-center">
                <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                  <ul class="list-marked-2 box-categories-list">
                    <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-1-368x420.jpg" alt="" width="368" height="420"/></a>
                ...
                <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                  <ul class="list-marked-2 box-categories-list">
                    <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-2-368x420.jpg" alt="" width="368" height="420"/></a>
                ...
                <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                  <ul class="list-marked-2 box-categories-list">
                    <li><a href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/cta-3-368x420.jpg" alt="" width="368" height="420"/></a>
      ...
      <section class="section section-sm section-first bg-default text-md-left">
        <div class="container">
          <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            <div class="col-lg-6 text-center wow fadeInUp"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/index-3-556x382.jpg" alt="" width="556" height="382"/>
            </div>
      ...
      <!--	Our Services-->
      <section class="section section-sm" id="service">
        <div class="container">
          <h3>Our Services</h3>
      ...
      <!-- Hot tours-->
      <section class="section section-sm bg-default" id="hot">
        <div class="container">
          ...
          <div class="row row-sm row-40 row-md-50">
            <div class="col-sm-6 col-md-12 wow fadeInRight">
              ...
              <article class="product-big">
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/product-big-1-600x366.jpg" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
            ...
            <div class="col-sm-6 col-md-12 wow fadeInLeft">
              ...
              <article class="product-big">
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="#"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/product-big-2-600x366.jpg" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
          ...
          <div class="row row-30 justify-content-center box-ordered">
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles" src="https://ld-wt73.template-help.com/wt_prod-20476/images/user-1-118x118.jpg" alt="" width="118" height="118"/></a>
                ...
                <div class="team-modern-caption">
                  ...
                  <h6 class="team-modern-phone"><a href="https://wa.me/6285604056893" target="_blank">+62 856-040-56893</a></h6>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles" src="https://ld-wt73.template-help.com/wt_prod-20476/images/user-2-118x118.jpg" alt="" width="118" height="118"/></a>
                  <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                    <g>
                      <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                    </g>
                ...
                <div class="team-modern-caption">
                  ...
                  <h6 class="team-modern-phone"><a href="tel:#">+62 856-040-56893</a></h6>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles" src="https://ld-wt73.template-help.com/wt_prod-20476/images/user-3-118x118.jpg" alt="" width="118" height="118"/></a>
                  <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                    <g>
                      <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                    </g>
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles" src="https://ld-wt73.template-help.com/wt_prod-20476/images/user-4-118x118.jpg" alt="" width="118" height="118"/></a>
                  <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                    <g>
                      <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                    </g>
      ...
      <section class="section bg-default text-center offset-top-50">
        <div class="parallax-container" data-parallax-img="https://ld-wt73.template-help.com/wt_prod-20476/images/parallax-1-1920x850.jpg">
        ...
        <div class="container-fluid">
          ...
          <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-xl-items="5" data-xxl-items="6" data-stage-padding="15" data-xxl-stage-padding="0" data-margin="30" data-autoplay="true" data-nav="true" data-dots="true">
            ...
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-1-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-1-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-1-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-2-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-2-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-2-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-3-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-3-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-3-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-4-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-4-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-4-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-5-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-5-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-5-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-6-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-6-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-6-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-7-270x195.jpg" alt="" width="270" height="195"/>
              </div>
              <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-7-1200x800-original.jpg" data-lightgallery="item"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/gallery-image-7-270x195.jpg" alt="" width="270" height="195"/></a>
              </div>
            </article>
          </div>
        </div>
      </section>
      <!-- Page Footer--><a class="banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" target="_blank"><img src="https://ld-wt73.template-help.com/wt_prod-20476/images/intense_big_02.jpg" alt=""/></a>
          ...
          <div class="container">
            <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
              ...
              <div class="col-sm-6 col-md-4 order-sm-first">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Wonder Tour</span>. All Rights Reserved. Design by <a href="https://www.templatemonster.com">Designer</a></p>
              </div>
